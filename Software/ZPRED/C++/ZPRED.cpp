...
{	//string salt="783e007c783e007c";
	...
	for(int i=0;i<Z.numSolCond;i++)
		...
		Output+="Collision Efficiency: "+formatNumberString(cnvrtNumToStrng(collisionEfficiency,BUFFER_SIZE))+"\n";
		...
		Output+="Coagulation Time: "+formatNumberString(cnvrtNumToStrng(coagulationTime,BUFFER_SIZE))+" s\n";
		Output+=repeatString("-",theLineWidth)+"|\n\n";
