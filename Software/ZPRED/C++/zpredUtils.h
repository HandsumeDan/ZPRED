...
# define zpredUtils_H
	...
	//# define h 6.62607015e-34		// (J Hz)
	# define h 4.135667696e-15
	...
	// For Hamaker Constant Calculation
	// Complex Refractive Index Values
	struct dielectricData
	{int N;double *refractiveIndex;double *extinctionCoefficient;double *realPermittivity;double *imagPermittivity;double *waveLength;};
