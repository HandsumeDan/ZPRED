...
double calc_collision_efficiency(collisionParameters cP1,collisionParameters cP2,double er,double debyeLength,double T)
	{// Input
	...
	for(int i=0;i<numPnts;i++)
		...
		trm2=2*cP1.Rp*cP2.Rp/(x[i]*x[i]+2*cP1.Rp*x[i]+2*cP2.Rp*x[i]);
		trm3=2*cP1.Rp*cP2.Rp/(x[i]*x[i]+2*cP1.Rp*x[i]+2*cP2.Rp*x[i]+4*cP1.Rp*cP2.Rp);
